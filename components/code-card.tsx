export function AboutCodeCard() {
  const lines = [
    <span key="1">{"{"}</span>,
    <span key="2"><span className="syn-key">&quot;当前方向&quot;</span>: <span className="syn-string">&quot;AI 应用开发&quot;</span>,</span>,
    ...
    <span key="5">&nbsp;&nbsp;<span className="syn-string">&quot;跨端产品&quot;</span>, <span className="syn-string">&quot;开发者工具&quot;</span></span>,
    <span key="6">],</span>,
    <span key="7"><span className="syn-key">&quot;交付方式&quot;</span>: <span className="syn-string">&quot;从需求到上线&quot;</span>,</span>,
    <span key="8"><span className="syn-key">&quot;关注重点&quot;</span>: [</span>,
    <span key="9">&nbsp;&nbsp;<span className="syn-string">&quot;用户体验&quot;</span>, <span className="syn-string">&quot;工程质量&quot;</span>,</span>,
    <span key="10">&nbsp;&nbsp;<span className="syn-string">&quot;产品价值&quot;</span></span>,
    <span key="11">]</span>,
    <span key="12">{"}"}</span>,
  ];
